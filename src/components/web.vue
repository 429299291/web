<template>
  <div class="web">
  <el-timeline  data-aos="fade-right" data-aos-easing="linear" data-aos-duration="1500">
    <el-timeline-item
  ...
  data () {
    return {
      ...
      year:2020,
        activities: [{
          content: '产品',
          timestamp: '市场分析，产品定位，用户行为，需求分析，思维脑图，业务流程图，产品原型',
          size: 'large',
          type: 'warning',
...
.el-timeline{padding-top: 2rem;padding-left: 10%;}
